...
const performers = [
  { name: "Rashmitha J", deals: 24, revenue: "$487,500", change: "+15%", rank: 1 },
  { name: "Team Member 2", deals: 19, revenue: "$356,200", change: "+8%", rank: 2 },
  { name: "Team Member 3", deals: 17, revenue: "$312,800", change: "+12%", rank: 3 },
  { name: "Team Member 4", deals: 15, revenue: "$289,400", change: "+5%", rank: 4 },
  { name: "Team Member 5", deals: 14, revenue: "$267,100", change: "+9%", rank: 5 },
];
