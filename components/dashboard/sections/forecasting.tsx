...
const riskFactors = [
  {
    ...
    impact: "-$180,000",
    severity: "high",
    deals: ["Orbital Dynamics Enterprise", "Meridian Phase 2", "Streamline Analytics"],
  },
  {
    id: 2,
    ...
    impact: "-$95,000",
    severity: "medium",
    deals: ["Catalyst Solutions", "Skyline Cloud Expansion"],
  },
  {
    id: 3,
    ...
    impact: "-$120,000",
    severity: "high",
    deals: ["Vertex Labs", "Nimbus Startups"],
  },
];
