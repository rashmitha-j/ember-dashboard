...
const initialStages: Stage[] = [
  {
    ...
    total: 892000,
    deals: [
      { id: "1", company: "Ignis Technologies", value: 45000, rep: "Rashmitha J.", daysInStage: 3, probability: 20 },
      { id: "2", company: "Lumen Systems", value: 78000, rep: "Member 2", daysInStage: 5, probability: 25 },
      { id: "3", company: "CoreAxis Inc", value: 32000, rep: "Member 3", daysInStage: 1, probability: 15 },
    ],
  },
  {
    id: "qualified",
    ...
    total: 556000,
    deals: [
      { id: "4", company: "Primewave Ltd", value: 125000, rep: "Member 4", daysInStage: 7, probability: 40 },
      { id: "5", company: "Stratus Nine Corp", value: 89000, rep: "Rashmitha J.", daysInStage: 4, probability: 45 },
    ],
  },
  {
    id: "proposal",
    ...
    total: 357000,
    deals: [
      { id: "6", company: "Forgeline Tech", value: 167000, rep: "Member 2", daysInStage: 12, probability: 60 },
      { id: "7", company: "Vantage Plus", value: 95000, rep: "Member 5", daysInStage: 8, probability: 65 },
      { id: "8", company: "GridPulse Co", value: 54000, rep: "Member 3", daysInStage: 6, probability: 55 },
    ],
  },
  {
    id: "negotiation",
    ...
    total: 179000,
    deals: [
      { id: "9", company: "Apex Enterprise", value: 245000, rep: "Rashmitha J.", daysInStage: 15, probability: 80 },
      { id: "10", company: "Momentum Lab", value: 112000, rep: "Member 4", daysInStage: 10, probability: 75 },
    ],
  },
];
